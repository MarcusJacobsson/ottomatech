        ...
        <div id="page-content-wrapper">
            ...
            <div class="page-content inset" data-spy="scroll" data-target="#spy">
                ...
                <div class="container container-sale">
                    ...
                    <div class="row">
                        <h2>Check out what's for sale</h2>
                        <h4>Interested? Send an email to: <a href="mailto:info@ottmatech.se">info@ottmatech.se</a></h4>
                        <h4>Or call +(46)(0)720-372259</h4>
                        <hr>
                        ...
                        if (is_array($categories)) {
                            ...
                            echo ' <br><br><br><h4>No ads at the moment. Keep your eyes open for updates!</h4>';
                        }
