    ...
    <div class="container">
        <div class="row pns" id="first">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                <h2>Vi erbjuder våra kunder ett brett urval av tjänster.</h2>
                <hr>
            </div>
        ...
        <div class="row pns">
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                <p class="lead">Maskinkommunikation</p>
                <ul>
                    <li>PROFIBUS</li>
                    <li>ETHERNET</li>
                    <li>ASI</li>
        ...
        <div class="row pns">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <p class="lead">Teknisk administration</p>
                <ul>
                    <li>Rapportering</li>
                    <li>Dokumentation</li>
                    <li>OPC</li>
        ...
        <div class="row pns">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <h2>Vi erbjuder även assistans inom</h2>
                <ul>
                    <li><p class="lead">Automation</p></li>
                    <li><p class="lead">Industriell el</p></li>
                    <li><p class="lead">Elsäkerhet</p></li>
                    <li><p class="lead">Projekt & Service</p></li>
                    <li><p class="lead">Utbildning, Coaching & Konsulting</p></li>
                </ul>
            </div>
        </div>
    </div>
