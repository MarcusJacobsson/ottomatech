    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li id="nav_item_about"><a href="about.php">Om oss</a></li>
                <li id="nav_item_services"><a href="services.php">Tjänster</a></li>
                <li id="nav_item_news"><a href="news.php">Nyheter</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li class="active"><a href="index.php">Svenska</a></li>
                        <li><a href="../en/<?php echo basename($_SERVER['PHP_SELF']); ?>">English</a></li>
                    </ul>
                </li>
            </ul>
        </div>
